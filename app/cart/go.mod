module github.com/gomall_project/app/cart
...
require (
	...
	github.com/gomall_project/rpc_gen v0.0.0-00010101000000-000000000000
...
replace github.com/gomall_project/rpc_gen => ../../rpc_gen
